...
class appdata(models.Model):
    bla_number = models.CharField(primary_key=True, max_length=50)
    application_path = models.TextField(null=True, max_length=1000)
    review = models.CharField(null=True, max_length=100)
    applicant_name = models.CharField(null=True, max_length=1000)
    proprietary_name = models.CharField(null=True, max_length=500)
    nonproprietary_name = models.CharField(null=True, max_length=500)
    obp_systematic_name = models.CharField(null=True, max_length=1000)
    dosage_form = models.CharField(null=True, max_length=50)
    strength_potency = models.CharField(null=True, max_length=100)
    route_administration = models.CharField(null=True, max_length=100)
    primary_assessor = models.CharField(null=True, max_length=300)
    secondary_assessor = models.CharField(null=True, max_length=300)
    drug = models.CharField(null=True, max_length=300)
    review_iteration = models.CharField(null=True, max_length=300)
    reviewer_decision = models.CharField(null=True, max_length=300)
    submission_date = models.DateField(null=True, blank=True)

    def __str__(self):
        return self.applicant_name
    class Meta:
        db_table = 'kasaapp_appdata'


class riskevaldata(models.Model):
    bla_number = models.ForeignKey(appdata, null=True, on_delete=models.CASCADE)
