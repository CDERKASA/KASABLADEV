...
def characterization(request):
    ...
    bla_number_id = request.POST.get('bla_number_id')
    ...
    a = riskevaldata.objects.filter(bla_number_id=bla_number_id, unitop_text=unitop_text, procname_text=procname_text)
    if len(a) == 0:
        saverecord = riskevaldata(bla_number_id=bla_number_id, unitop_text=unitop_text, procname_text=procname_text,
                                  cppdropdownselect=cppdropdownselect,characir_comments=characir_comments,appro_charac_ircomments=appro_charac_ircomments, study_appropriate_select=study_appropriate_select,
                                  characterization_study_pk= characterization_study_pk, pk_ircomments=pk_ircomments, charac_range_low=charac_range_low, charac_range_high=charac_range_high,charac_range_ircomments=charac_range_ircomments,
                                  validation_select=validation_select, prelir_ircomments=prelir_ircomments, valid_range_low=valid_range_low,valid_range_high=valid_range_high,ircommentsvalrange=ircommentsvalrange,
                                  par_ircomments=par_ircomments,par_range_low=par_range_low,par_range_high=par_range_high,response_select=response_select,
                                  pp_range_select=pp_range_select,ircommentsprop_par=ircommentsprop_par)

        saverecord.save()

    else:
        z = a[0]
        z.cppdropdownselect = cppdropdownselect
        z.characir_comments= characir_comments
        z.study_appropriate_select = study_appropriate_select
        z.appro_charac_ircomments= appro_charac_ircomments
        z.characterization_study_pk = characterization_study_pk
        z.pk_ircomments = pk_ircomments
        z.charac_range_low = charac_range_low
        z.charac_range_high = charac_range_high
        z.charac_range_ircomments = charac_range_ircomments
        z.validation_select = validation_select
        z.prelir_ircomments = prelir_ircomments
        z.valid_range_low = valid_range_low
        z.valid_range_high = valid_range_high
        z.ircommentsvalrange = ircommentsvalrange
        z.par_ircomments = par_ircomments
        z.par_range_low = par_range_low
        z.par_range_high = par_range_high
        z.response_select = response_select
        z.pp_range_select = pp_range_select
        z.ircommentsprop_par = ircommentsprop_par
        z.save()
