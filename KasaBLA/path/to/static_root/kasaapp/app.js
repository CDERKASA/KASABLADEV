$(document).ready (function() {
   ...
   function doSomething(alpha, beta) {
    var y = document.getElementById(alpha).textContent;
    alert("you have selected: " + y);
...
function intoDrop(alpha1, beta1) {
    clicked = true;
    var a = document.getElementById(alpha1);
    var b = document.getElementById("unitoperations");
    var c = document.getElementById(beta1);
    var children = document.getElementById("draggable").getElementsByTagName("li");
    var i;
    for(i=0; i <children.length; i++){
    children[i].firstChild.style.background='';
    }
    while(clicked) {
        clicked = false;
        a.style.background ='dodgerblue';
        var option = document.createElement("option");
        option.text = c.textContent;
        b.append(option);
...
function myFunction() {
        ...
        var ntagree_m = document.getElementById("notagree_m");
        ...
        blockmyFunction1();
            ...
            if (risk_p === risk_r) {
                    ...
                    assessor.innerHTML= "Assessor agrees with Applicant Risk Ranking";
                    ntagree.style.display = "none";
                    ntagree_m.style.display = "none";
                ...
                if (risk_p === "--Select--") {
                    ...
                    agree_message.style.display = "none";
                    finalrisk.style.display = "none";
                    ntagree_m.style.display = "block";
                    ntagree_message.innerHTML= "Assessor does not agree with Applicant Risk Ranking";
...
function blockmyFunction() {
        ...
        var notagree_m1 = document.getElementById("notagree_m");
...
function unitFun() {
        ...
        var procdefault = document.getElementById("processparameter");
        procdefault.selectedIndex = "default";

        var applicantrisk = document.getElementById("risk");
        applicantrisk.selectedIndex = "default";
   ...
   var chart = new Chart(ctx, {
      ...
      data: {
        ...
        data:[charac_range_low,valid_range_low, par_range_low],
         ...
         {
        label: 'High',
        data:[charac_range_high,valid_range_high,par_range_high],
